...
export default function DisplayPage() {
  ...
  if (loading || !session) {
    return (
      <div className="relative min-h-screen flex flex-col items-center justify-center gap-6 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <GridScan linesColor="#1a0a2e" scanColor="#06b6d4" gridScale={0.12} lineThickness={1} />
        </div>
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <AnimatePresence mode="wait">
          ...
          {session.status === 'waiting' && (
            ...
            >
              {/* Animated RotatingText title */}
              <div
                className="text-[90px] font-black leading-none text-center overflow-hidden"
                style={{ height: '110px' }}
              >
                <RotatingText
                  texts={['بوابة القرار', 'استعد للعبة!', 'من سيفوز؟', 'اختر بحكمة']}
