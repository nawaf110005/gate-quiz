...
export default function PlayerOrb({
  ...
  // RTL layout: Portal A is physical RIGHT, Portal B is physical LEFT
  const PORTAL_X = 230;
  ...
  return (
    <motion.div
      ...
      transition={{
        x: { duration: 0.75, delay: choice ? groupIndex * 0.04 : 0, ease: 'easeOut' },
        y: { duration: 0.75, delay: choice ? groupIndex * 0.04 : 0, ease: 'easeOut' },
